  ...
  <section class="ldp-why-choose">
    <div class="ldp-container">
      <div class="ldp-why-choose__header">
        <h2 class="ldp-why-choose__title"><?php echo esc_html( $why_choose_title ); ?></h2>
        <p class="ldp-why-choose__intro"><?php echo esc_html( $why_choose_intro ); ?></p>
      </div>
      ...
      <div class="ldp-why-choose__track-record">
        <div class="ldp-why-choose__track-record-text">
          ...
          <p><?php echo esc_html( $why_choose_items[0]['paragraph'] ?? '' ); ?></p>
        </div>
      ...
      <div class="ldp-why-choose__fee-structure">
        ...
        <div class="ldp-why-choose__fee-text">
          ...
          <p><?php echo esc_html( $why_choose_items[1]['paragraph'] ?? '' ); ?></p>
        </div>
      </div>
      ...
      <div class="ldp-why-choose__attorneys">
        <div class="ldp-why-choose__attorneys-text">
          ...
          <p><?php echo esc_html( $why_choose_items[2]['paragraph'] ?? '' ); ?></p>
        </div>
      ...
      <div class="ldp-cta-card ldp-container">
        ...
        <div class="ldp-cta-card__body">
          <div class="ldp-cta-card__text">
            ...
            <p class="ldp-cta-card__desc"><?php echo esc_html( $cta_cards[0]['description'] ?? '' ); ?></p>
          </div>
  ...
  <section class="ldp-case-results">
    <div class="ldp-container">
      <div class="ldp-case-results__header">
        <h3 class="ldp-section-title"><?php echo esc_html( $case_results_title ); ?></h3>
        <p class="ldp-section-subtitle"><?php echo esc_html( $case_results_subtitle ); ?></p>
      </div>
        ...
        <?php foreach ( $case_results as $index => $case ) : ?>
          ...
          <article class="ldp-case-card <?php echo esc_attr( $is_right ? 'ldp-case-card--img-right' : 'ldp-case-card--img-left' ); ?>">
            ...
            <?php endif; ?>
              ...
              <p class="ldp-case-card__desc<?php echo esc_attr( $is_right ? ' ldp-case-card__desc--right' : '' ); ?>"><?php echo esc_html( $case['description'] ?? '' ); ?></p>
            </div>
  ...
  <section class="ldp-testimonial">
    <div class="ldp-container ldp-testimonial__inner">
      <div class="ldp-testimonial__header">
        <h3 class="ldp-section-title"><?php echo esc_html( $testimonials_title ); ?></h3>
        <?php if ( ! empty( $testimonials_subtitle ) ) : ?>
          <p class="ldp-section-subtitle"><?php echo esc_html( $testimonials_subtitle ); ?></p>
        <?php endif; ?>
      </div>
    ...
    <div class="ldp-container">
      <div class="ldp-how-we-help__row ldp-how-we-help__row--text-left">
        <div class="ldp-how-we-help__text">
          <h3 class="ldp-section-title"><?php echo esc_html( $how_we_help_title ); ?></h3>
          <?php if ( ! empty( $how_we_help_intro ) ) : ?>
            <p><?php echo esc_html( $how_we_help_intro ); ?></p>
          <?php endif; ?>
        </div>
      ...
      <?php foreach ( $how_we_help_items as $how_help_item ) : ?>
        ...
        <div class="ldp-how-we-help__row <?php echo esc_attr( $item_row_class ); ?>">
          <?php if ( 'left' === $item_position ) : ?>
            ...
            <div class="ldp-how-we-help__text">
              <p><?php echo esc_html( $how_help_item['text'] ?? '' ); ?></p>
            </div>
          <?php else : ?>
            <div class="ldp-how-we-help__text">
              <p><?php echo esc_html( $how_help_item['text'] ?? '' ); ?></p>
  ...
  <section class="ldp-faq" id="faq">
    <div class="ldp-container">
      <div class="ldp-faq__header">
        <h3 class="ldp-section-title ldp-section-title--center"><?php echo esc_html( $faq_title ); ?></h3>
      </div>
        ...
        <div class="ldp-cta-card ldp-cta-card--faq" id="contact">
          ...
          <div class="ldp-cta-card__body">
            <div class="ldp-cta-card__text">
              ...
              <p class="ldp-cta-card__desc"><?php echo esc_html( $cta_cards[1]['description'] ?? '' ); ?></p>
            </div>
            <div class="ldp-cta-card__actions">
