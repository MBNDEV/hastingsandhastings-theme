    ...
    <div class="flex items-center justify-center gap-5 py-4 px-4">
      ...
      <?php if ( ! empty( $mobile_contact_url ) ) : ?>
        <a 
          ...
          class="flex-1 flex items-center justify-center gap-2 py-4 px-6 border-2 border-primary bg-text-heading text-white hover:bg-white hover:text-footer-bg font-bold text-base rounded-full hover:bg-opacity-90 transition-all duration-300 shadow-lg"
