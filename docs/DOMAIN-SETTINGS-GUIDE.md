...
**Example:**
- You export a page on local with images like: `https://hastingsandhastings.dev.local/wp-content/uploads/hero.jpg`
- You import to staging
- URLs automatically become: `https://newsite-staging.hastingsandhastings.com/wp-content/uploads/hero.jpg`
...
1. **On Local Development:**
   ...
   - Enter:
     - **Local URL**: `https://hastingsandhastings.dev.local`
     - **Deployment URL**: `https://newsite-staging.hastingsandhastings.com`
   - Click "💾 Save Settings"
...
[https://hastingsandhastings.dev.local          ]
Your local development domain (e.g., Laragon, XAMPP, Local WP)

🌐 Deployment Server URL
[https://newsite-staging.hastingsandhastings.com       ]
...
**Invalid:**
- ❌ `hastingsandhastings.dev.local` (missing http/https)
...
```php
// Set local URL
update_option( 'custom_theme_local_url', 'https://hastingsandhastings.dev.local' );

// Set deployment URL
update_option( 'custom_theme_deployment_url', 'https://newsite-staging.hastingsandhastings.com' );
```
