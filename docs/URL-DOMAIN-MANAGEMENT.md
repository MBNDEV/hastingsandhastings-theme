...
Example:
- Local: `https://hastingsandhastings.dev.local/wp-content/uploads/...`
- Staging: `https://newsite-staging.hastingsandhastings.com/wp-content/uploads/...`
...
3. You'll see URLs like: `https://hastingsandhastings.dev.local/...`
4. Import on staging
5. Edit page in WordPress admin
6. URLs should now be: `https://newsite-staging.hastingsandhastings.com/...`
...
```bash
# In theme directory
php scripts/replace-domains.php --from="hastingsandhastings.dev.local" --to="newsite-staging.hastingsandhastings.com"
```
