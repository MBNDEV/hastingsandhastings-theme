...
3. Enter your URLs in the two simple fields:
   - **🏠 Local Development URL**: `https://hastingsandhastings.dev.local`
   - **🌐 Deployment Server URL**: `https://newsite-staging.hastingsandhastings.com`
...
**Example:**
```
FROM: https://hastingsandhastings.dev.local/wp-content/uploads/2026/04/hero.jpg
TO:   https://newsite-staging.hastingsandhastings.com/wp-content/uploads/2026/04/hero.jpg
```
...
```bash
cd wp-content/themes/hastingsandhastings-theme

# Dry run (preview only)
php scripts/replace-domains.php \
  --from="hastingsandhastings.dev.local" \
  --to="newsite-staging.hastingsandhastings.com" \
  --dry-run
