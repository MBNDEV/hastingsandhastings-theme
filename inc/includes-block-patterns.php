 ...
 */
function hastingsandhastings_register_pattern_category() {
	register_block_pattern_category(
      'hastingsandhastings',
      array(
		  'label' => __( 'Hastings And Hastings', 'mbn-theme' ),
	  )
	);
}
add_action( 'init', 'hastingsandhastings_register_pattern_category' );

/**
 * Register block patterns.
 */
function hastingsandhastings_register_block_patterns() {

	// Hero + Content Pattern.
	register_block_pattern(
      'hastingsandhastings/hero-with-content',
      array(
		  ...
		  'categories'  => array( 'hastingsandhastings' ),
...
<!-- /wp:group -->',
	...
	register_block_pattern(
      'hastingsandhastings/two-column-content',
      array(
...
<!-- /wp:columns -->',
	...
	register_block_pattern(
      'hastingsandhastings/home-page-template',
      array(
...
add_action( 'init', 'hastingsandhastings_register_block_patterns' );
