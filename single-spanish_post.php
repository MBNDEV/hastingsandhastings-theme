<?php
/**
 * Single Spanish Post template.
 *
 * Mirrors single.php but with Spanish chrome: breadcrumb to the
 * espanol-posts landing page, spanish_post_category terms, Spanish UI
 * strings, and recent articles pulled from the spanish_post post type.
 *
 * @package CustomTheme
 */
...
<main id="main" class="site-main">
  ...
  if ( have_posts() ) :
    while ( have_posts() ) :
      ...
      $posts_page_url  = home_url( '/' . CUSTOM_THEME_SPANISH_POSTS_PAGE_SLUG . '/' );

      $categories = get_the_terms( $current_post_id, 'spanish_post_category' );
      ...
      <section class="blog-hero">
        <div class="blog-hero__container">
          ...
          <nav class="blog-hero__breadcrumb" aria-label="<?php esc_attr_e( 'Ruta de navegación', 'mbn-theme' ); ?>">
            <ol>
          ...
          <div class="blog-hero__meta">
            <div class="blog-hero__share">
              <span class="blog-hero__share-label"><?php esc_html_e( 'Compartir en:', 'mbn-theme' ); ?></span>
              <ul class="blog-hero__share-icons" aria-label="<?php esc_attr_e( 'Compartir en redes sociales', 'mbn-theme' ); ?>">
                <li>
                  <a href="<?php echo esc_url( $share_links['x'] ); ?>" aria-label="<?php esc_attr_e( 'Compartir en X (Twitter)', 'mbn-theme' ); ?>" target="_blank" rel="noopener noreferrer">
                ...
                <li>
                  <a href="<?php echo esc_url( $share_links['facebook'] ); ?>" aria-label="<?php esc_attr_e( 'Compartir en Facebook', 'mbn-theme' ); ?>" target="_blank" rel="noopener noreferrer">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                  </a>
                </li>
                <li>
                  <a href="<?php echo esc_url( $share_links['linkedin'] ); ?>" aria-label="<?php esc_attr_e( 'Compartir en LinkedIn', 'mbn-theme' ); ?>" target="_blank" rel="noopener noreferrer">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                  </a>
                </li>
                <li>
                  <a href="<?php echo esc_url( $share_links['email'] ); ?>" aria-label="<?php esc_attr_e( 'Compartir por correo electrónico', 'mbn-theme' ); ?>">
            ...
            <div class="blog-hero__actions">
              <button class="blog-hero__action-btn blog-hero__action-btn--light" aria-label="<?php esc_attr_e( 'Cambiar a modo claro', 'mbn-theme' ); ?>" data-theme-toggle="light" type="button">
              ...
              <button class="blog-hero__action-btn blog-hero__action-btn--dark" aria-label="<?php esc_attr_e( 'Cambiar a modo oscuro', 'mbn-theme' ); ?>" data-theme-toggle="dark" type="button">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <article class="blog-content">
        <div class="blog-content__container">
          ...
          <div class="blog-content__share-bar">
            <span class="blog-content__share-label"><?php esc_html_e( 'Compartir en', 'mbn-theme' ); ?></span>
            <ul class="blog-content__share-icons" aria-label="<?php esc_attr_e( 'Compartir artículo en redes sociales', 'mbn-theme' ); ?>">
              <li>
                <a href="<?php echo esc_url( $share_links['x'] ); ?>" aria-label="<?php esc_attr_e( 'Compartir en X (Twitter)', 'mbn-theme' ); ?>" target="_blank" rel="noopener noreferrer">
      ...
      <div class="blog-content__cta-container">
        <aside class="blog-content__cta" aria-label="<?php esc_attr_e( 'Llamado a la acción de consulta gratuita', 'mbn-theme' ); ?>">
          ...
          <h4 class="blog-content__cta-title"><?php esc_html_e( 'Comience Su Consulta Gratuita', 'mbn-theme' ); ?></h4>
          <p class="blog-content__cta-text"><?php esc_html_e( 'Si no está seguro de por dónde empezar o cómo manejar sus opciones, hablar con un abogado experimentado en lesiones personales puede ayudarle a determinar el mejor camino a seguir.', 'mbn-theme' ); ?></p>
          <div class="blog-content__cta-actions">
            <a href="/contact-us/" class="blog-content__cta-btn"><?php esc_html_e( 'CONTÁCTENOS HOY PARA PROGRAMAR UNA CONSULTA GRATUITA', 'mbn-theme' ); ?></a>
            <p class="blog-content__cta-phone"><span><?php esc_html_e( 'LLAME HOY', 'mbn-theme' ); ?></span> <a href="tel:4806053939">(480) 605-3939</a></p>
          </div>
        </aside>
      </div>
        ...
        if ( $recent_posts_query->have_posts() ) :
          ...
          <section class="recent-articles">
            <div class="recent-articles__container">
              ...
              <h2 class="recent-articles__heading"><?php esc_html_e( 'Artículos Recientes', 'mbn-theme' ); ?></h2>
                    ...
                    <article class="recent-articles__card">
                      ...
                      <div class="recent-articles__card-body">
                        ...
                        <a href="<?php echo esc_url( $recent_permalink ); ?>" class="recent-articles__card-read-more">
                          <span class="recent-articles__card-read-more-label"><?php esc_html_e( 'Leer Más', 'mbn-theme' ); ?></span>
