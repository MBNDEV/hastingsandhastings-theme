 ...
 */
function hastingsandhastings_enqueue_scroll_animations() {
	wp_enqueue_script( 'jquery' );

	wp_enqueue_style(
      'hastingsandhastings-scroll-animations',
	...
	wp_add_inline_style( 'hastingsandhastings-scroll-animations', $animation_css );
 ...
 */
function hastingsandhastings_conditional_gform_css() {
  if ( is_admin() ) {
...
add_filter( 'gform_disable_css', 'hastingsandhastings_conditional_gform_css' );
 ...
 */
function hastingsandhastings_validate_donation_amount( $result, $value, $form, $field ) {
